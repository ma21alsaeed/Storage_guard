...
class OperationRepositories {
  ...
  Future<Either<Failure, void>> sendSensorRecordings(
      ...
      await repository(() async =>
          await _operationDataSource.sendSensorRecordings(data, operationId));
  ...
  Future<Either<Failure, void>> endOperation(int operationId) async =>
      await repository(
          () async => await _operationDataSource.endOperation(operationId));
}
